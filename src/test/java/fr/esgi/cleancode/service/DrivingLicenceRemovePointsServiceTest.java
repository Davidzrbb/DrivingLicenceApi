...
public class DrivingLicenceRemovePointsServiceTest {
    ...
    void should_remove_points_positive() {
        ...
        when(database.save(any(), any(DrivingLicence.class))).thenReturn(drivingLicence.withAvailablePoints(Math.max(drivingLicence.getAvailablePoints() - pointsToRemove, 0)));
